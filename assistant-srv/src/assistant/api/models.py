...
async def add_model(
    ...
    try:
        model = await model_service.add_model(Model.from_dict({**model_data.dict(), "owner": owner}))
        return ModelResponseData.from_model(model)
...
async def update_model(
    ...
    try:
        ...
        updated_model = Model(
            ...
            description=update_dict.get("description", existing_model.description),
            default_params=update_dict.get("default_params", existing_model.default_params),
